    ...
    <Dialog as="div" @close="$emit('close')" class="relative z-[100]">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-[2.5rem] bg-white p-8 text-left align-middle shadow-sm border border-slate-200 transition-all border border-slate-100">
              <div class="flex justify-between items-center mb-8">
                <DialogTitle as="h3" class="text-lg font-black text-slate-900 tracking-tight">
                  Share Story
                </DialogTitle>
              ...
              <div class="grid grid-cols-2 gap-4 mb-8">
                ...
                <a :href="shareLinks.whatsapp" target="_blank" class="flex flex-col items-center justify-center p-6 bg-[#25D366]/5 rounded-3xl border border-[#25D366]/10 hover:bg-[#25D366]/10 transition-all group">
                  <div class="w-12 h-12 bg-[#25D366] text-white rounded-2xl flex items-center justify-center mb-3 shadow-sm border border-slate-100 shadow-[#25D366]/20 group-hover:scale-110 transition-transform">
                  ...
                  <span class="text-sm font-bold text-slate-600">WhatsApp</span>
                </a>
                ...
                <a :href="shareLinks.twitter" target="_blank" class="flex flex-col items-center justify-center p-6 bg-slate-900/5 rounded-3xl border border-slate-900/10 hover:bg-slate-900/10 transition-all group">
                  <div class="w-12 h-12 bg-slate-900 text-white rounded-2xl flex items-center justify-center mb-3 shadow-sm border border-slate-100 shadow-slate-900/20 group-hover:scale-110 transition-transform">
                  ...
                  <span class="text-sm font-bold text-slate-600">Twitter / X</span>
                </a>
                ...
                <a :href="shareLinks.facebook" target="_blank" class="flex flex-col items-center justify-center p-6 bg-[#1877F2]/5 rounded-3xl border border-[#1877F2]/10 hover:bg-[#1877F2]/10 transition-all group">
                  <div class="w-12 h-12 bg-[#1877F2] text-white rounded-2xl flex items-center justify-center mb-3 shadow-sm border border-slate-100 shadow-[#1877F2]/20 group-hover:scale-110 transition-transform">
                  ...
                  <span class="text-sm font-bold text-slate-600">Facebook</span>
                </a>
                ...
                <button @click="triggerNativeShare" class="flex flex-col items-center justify-center p-6 bg-indigo-600/5 rounded-3xl border border-indigo-600/10 hover:bg-indigo-600/10 transition-all group">
                  <div class="w-12 h-12 bg-indigo-600 text-white rounded-2xl flex items-center justify-center mb-3 shadow-sm border border-slate-100 shadow-indigo-600/20 group-hover:scale-110 transition-transform">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"/></svg>
                  </div>
                  <span class="text-sm font-bold text-slate-600">More</span>
                </button>
              </div>
