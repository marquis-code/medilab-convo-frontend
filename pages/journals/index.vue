    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Journo</h2>
            <p class="mt-6 text-lg leading-8 text-gray-100">Journo is the go-to platform for insightful stories, expert perspectives, and in-depth analysis on all things related to medical laboratory science and healthcare. Whether you’re a student, a professional, or just passionate about healthcare, Journo delivers content that informs, educates, and sparks conversation within the medical community.</p>
          </div>
        </div>
      </div>
    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
      <div class="max-w-xl lg:max-w-lg">
        ...
        <!-- <div class="mt-6 max-w-md gap-x-4 space-y-5">
         ...
         <div class="w-full">
          ...
          <input id="email-address" name="email" type="email" autocomplete="email" required class="min-w-full flex-auto rounded-md border-0 bg-white/5 px-3.5 py-3 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6" placeholder="Last Name *">
         </div>
         <div class="w-full">
      ...
      <!-- <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
        <div class="flex flex-col items-start">
          ...
          <dd class="mt-2 leading-7 text-gray-200">Non laboris consequat cupidatat laborum magna. Eiusmod non irure cupidatat duis commodo amet.</dd>
        </div>
        <div class="flex flex-col items-start">
          <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
            <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
      ...
      <div class="mx-auto max-w-lg">
        ...
        <dl class="mt-8 text-base text-gray-500">
          ...
          <div class="mt-6">
            ...
            <dd class="flex">
              <svg class="h-6 w-6 flex-shrink-0 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
