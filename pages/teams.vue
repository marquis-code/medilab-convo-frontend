              ...
              <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
                <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                  <div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">We’re changing the way people connect in Medical Laboratory Science.</h1>
        ...
        <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
            <div class="relative pl-9">
              ...
              <dd class="inline text-justify">We bridge the gaps in medical laboratory science education by providing cutting-edge resources, comprehensive training, and up-to-date information. From detailed guides to interactive workshops, we ensure you have the knowledge needed to stay at the forefront of the field.</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              ...
              <dd class="inline text-justify">Developing a growth mindset is essential for success in any profession. Our programs and resources are designed to foster resilience, adaptability, and a proactive approach to challenges. We help you cultivate the mindset needed to excel and lead in the dynamic world of healthcare.</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              ...
              <dd class="inline text-justify">Practical skills are crucial for advancing your career and making an impact. We offer a range of training opportunities, including hands-on workshops, courses, and mentorship programs, to enhance your technical and professional skills, ensuring you are well-prepared for the demands of the industry.</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
              ...
              <dd class="inline text-justify">Building a strong professional network opens doors to new opportunities and collaborations. MedLabConvo connects you with industry leaders, peers, and mentors through events, forums, and networking opportunities. Our community is your gateway to expanding your professional connections and finding support throughout your career.
            ...
            <div class="relative pl-9">
              ...
              <dd class="inline text-justify">Establishing a clear professional identity is key to standing out in the healthcare field. We provide guidance on personal branding, career development, and leadership, helping you define and communicate your unique value and purpose as a medical laboratory scientist</dd>
            </div>
          </dl>
        </div>
      </div> -->
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <li>
              ...
              <p class="text-base leading-7 text-gray-600">Executive Board</p>
            ...
            <li>
                <img class="aspect-[3/4] w-full rounded-2xl h-[500px] object-cover" src="@/assets/img/executive-board2.jpg" alt="">
                <h3 class="mt-6 text-lg font-semibold leading-8 tracking-tight text-gray-900">Chibuike Alagboso</h3>
                <p class="text-base leading-7 text-gray-600">Executive Board</p>
              </li>

              <li>
                <img class="aspect-[3/4] w-full rounded-2xl h-[500px] object-cover" src="@/assets/img/executive-board3.jpg" alt="">
                <h3 class="mt-6 text-lg font-semibold leading-8 tracking-tight text-gray-900">Dr. Olumide Ajani</h3>
                <p class="text-base leading-7 text-gray-600">Executive Board</p>
                <!-- <ul role="list" class="mt-6 flex gap-x-6">
                  <li>
                    <a href="#" class="text-gray-400 hover:text-gray-500">
    ...
    <div class="bg-white py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-2 gap-x-8 gap-y-16 text-center sm:grid-cols-3 md:grid-cols-4 lg:mx-0 lg:max-w-none lg:grid-cols-5 xl:grid-cols-6">   
            <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member1.jpg" alt="">
              ...
              <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member2.jpg" alt="">
                <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-900">Operations Co-Lead</h3>
                <p class="text-sm leading-6 text-gray-600">Boluwatife Fatokun</p>
              </li>

              <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member3.jpg" alt="">
                <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-900">Volunteer Mgt Co-Lead</h3>
                <p class="text-sm leading-6 text-gray-600">Victoria Omoloye</p>
              </li>

              <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member4.jpg" alt="">
                <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-900">Volunteer Mgt Co-Lead</h3>
                <p class="text-sm leading-6 text-gray-600">Opemipo Adetayo</p>
              </li>

              <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member5.png" alt="">
              ...
              <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member6.jpg" alt="">
                <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-900">Programs Co-Lead</h3>
                <p class="text-sm leading-6 text-gray-600">Glory Ogunbodede</p>
              </li>

              <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member7.jpg" alt="">
                <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-900">Fund. and Partners. Co-Lea</h3>
                <p class="text-sm leading-6 text-gray-600">Emmanuel Anya-Awa</p>
              </li>

              <li>
                <img class="mx-auto h-24 w-24 rounded-full" src="@/assets/img/member8.jpg" alt="">
