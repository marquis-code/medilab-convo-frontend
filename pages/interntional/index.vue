...
goals.`,
  ...
  },
  {
    ...
    // img: img4,
    firstPart: `Mental Health for Interns: Is a documentary visual storytelling project that aims to share the experiences of intern medical laboratory scientists. This time, our stories are told not just through written formats but through videos and images that evoke real-time emotions, reactions, and reflections on their mental health journeys.`,
    secondPart: `Every day, we young scientists navigate a complex web of interactions not only with patients but also with their relatives and fellow medical professionals. Each interaction brings its own challenges, perspectives, and emotions, shaping our experiences in profound ways.`,
    thirdPart: `Through compelling narratives and visuals, this project seeks to foster empathy and inspire hope for the next generation of scientists in the field.`,
    registerURL: "#",
  },
  {
