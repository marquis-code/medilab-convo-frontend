  ...
  <div class="min-h-screen bg-white">
    ...
    <div class="bg-[#27628C] py-24 md:py-32 px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="mx-auto max-w-7xl relative z-10">
           <div class="max-w-2xl">
              <h1 class="text-4xl md:text-6xl font-bold text-white leading-tight tracking-tighter  mb-4 animate-in fade-in slide-in-from-bottom-10 duration-1000">
                 Privacy Policy
              </h1>
              <p class="text-lg text-blue-100 font-medium leading-relaxed max-w-lg animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
                 Your trust is our priority. Learn how we handle and protect your personal data at MedLabConvo.
              </p>
           </div>
        </div>
    </div>
        ...
        <div class="prose prose-lg sm:prose-xl prose-slate max-w-none 
          ...
          <section class="mb-20">
            ...
            <ul class="space-y-4">
              ...
              <li>Professional information (Job Title, Institution)</li>
              <li>Interaction data (Comments, Likes, Enquiry history)</li>
            </ul>
          </section>
          ...
          <section class="mb-20">
            ...
            <ul class="space-y-4">
              ...
              <li>Responding to professional enquiries and requests.</li>
              <li>Processing community scholarship and program applications.</li>
              <li>Analyzing platform performance to enhance user experience.</li>
            </ul>
          </section>
...
useHead({
  title: 'Privacy Policy | MedLabConvo',
  meta: [
    { name: 'description', content: 'Our commitment to protecting your personal data and privacy.' }
  ]
})
</script>
