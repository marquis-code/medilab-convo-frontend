    ...
    <header class="absolute inset-x-0 top-0 z-50">
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <NuxtLink to="/journals" class="text-sm font-semibold leading-6 text-white">Journals</NuxtLink>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/25">
              <div class="space-y-2 py-6">
                <NuxtLink to="/journals" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Journals</NuxtLink>
                <NuxtLink to="/lab-cast" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">LabCast</NuxtLink>
                <NuxtLink to="/community" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Community</NuxtLink>
                <NuxtLink to="/programs" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Programs</NuxtLink>
                <NuxtLink to="/products" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Products</NuxtLink>
              </div>
              <div class="py-6">
                <NuxtLink to="/about" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-800">About</NuxtLink>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="relative isolate overflow-hidden pt-14">
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">Inspiring and building the capacity of future generations of world class professionals in medical laboratory science and in the healthcare system at large</p>
