<template>
<main>
  <div class="relative isolate overflow-hidden bg-gradient-to-br from-[#27628C] via-[#1e4d6b] to-[#27628C]">
    <div class="absolute inset-0 -z-10">
      <div class="absolute inset-0 bg-gradient-to-br from-[#27628C]/90 via-[#1e4d6b]/90 to-[#27628C]/90"></div>
      <img src="@/assets/img/hero-background.jpeg" alt="" class="absolute inset-0 w-full h-full object-cover opacity-20">
    </div>
    
    <!-- Animated background elements -->
    <div class="absolute inset-0 overflow-hidden">
      <div class="absolute -top-40 -left-20 w-80 h-80 bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse"></div>
      <div class="absolute -bottom-40 -right-20 w-96 h-96 bg-gradient-to-r from-blue-400/20 to-cyan-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
    </div>
    
    <div class="relative mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
      <div class="text-center">
        <h1 class="text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tight text-white mb-6 animate-fade-in">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mt-12">
          <a href="#programs" class="bg-white text-[#27628C] px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            Explore Programs
          </a>
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="relative rounded-3xl overflow-hidden shadow-2xl group">
        <iframe
          ...
          allowfullscreen
          class="w-full h-96 sm:h-[500px] lg:h-[600px] transition-transform duration-300 group-hover:scale-105"
        ></iframe>
  ...
  <section id="programs" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div v-if="programs.length > 0" v-for="(program, idx) in programs" :key="idx" class="group">
        <div v-if="program._id === '6868f7da037e8926971c5802'" class="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
          <div class="md:flex">
          <div class="md:w-1/2 relative overflow-hidden">
            ...
            <div class="absolute top-4 right-4 bg-[#27628C] text-white px-4 py-2 rounded-full text-sm font-semibold">
              Latest
            </div>
          </div>
  ...
  <div class="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
    ...
    <div class="p-8">
      ...
      <div v-else class="text-center py-20">
        <div class="bg-gradient-to-r from-[#27628C] to-blue-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
          <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
          </svg>
        </div>
        <p class="text-xl text-gray-600">No upcoming programs at the moment. Check back soon!</p>
      </div>
    </div>
  </section>
  ...
  <section class="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div v-if="loadingLabcasts" class="flex justify-center items-center py-20">
        <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-[#27628C]"></div>
      </div>
      ...
      <div v-else-if="labcasts?.length > 0" class="grid gap-8 md:gap-12">
        <div v-for="(episode, idx) in labcasts.filter(ep => ep.position === 1)" :key="idx" class="group">
          <div class="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            <div class="md:flex">
              <div class="md:w-1/2 relative overflow-hidden">
                <img :src="episode.image || episode.thumbnailUrl || '/api/placeholder/600/400'" alt="" class="w-full h-64 md:h-full object-cover group-hover:scale-110 transition-transform duration-700">
                <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div class="md:w-1/2 p-8 flex flex-col justify-center">
                <h3 class="text-2xl font-bold text-gray-900 mb-4 group-hover:text-[#27628C] transition-colors duration-300">
                ...
                <div class="flex flex-wrap gap-3">
                  <a
                    :href="episode.spotifyUrl || 'https://open.spotify.com/show/04S2XZGd6gczoCXStIrh8e'"
                    class="inline-flex items-center px-6 py-3 rounded-full bg-[#1DB954] text-white font-semibold hover:bg-[#1ed760] transition-all duration-300 transform hover:-translate-y-1"
                  >
                  ...
                  <a
                    :href="episode.appleUrl || 'https://podcasts.apple.com/podcast/id1234567890'"
                    class="inline-flex items-center px-6 py-3 rounded-full bg-black text-white font-semibold hover:bg-gray-800 transition-all duration-300 transform hover:-translate-y-1"
                  >
                    <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div class="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            <div class="md:flex">
              ...
              <div class="md:w-1/2 p-8 flex flex-col justify-center">
                ...
                <p class="text-gray-600 mb-6 leading-relaxed line-clamp-4">
                  {{ episode?.description || episode?.desc || 'Episode description' }}
                </p>
                <div class="flex flex-wrap gap-3">
                  <a
                    :href="episode.spotifyUrl || 'https://open.spotify.com/show/04S2XZGd6gczoCXStIrh8e'"
      ...
      <div v-else class="text-center py-20">
        ...
        <p class="text-xl text-gray-600">No episodes available at the moment. Check back soon!</p>
      </div>
    </div>
  </section>

  <!-- Publications/Journo Section -->
  <section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div v-if="loadingPublications" class="flex justify-center items-center py-20">
        <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-[#27628C]"></div>
      </div>
        ...
        <div v-for="(publication, idx) in publications.slice(0, 3)" :key="idx" class="group">
          <div class="bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div class="p-8">
              ...
              <p class="text-gray-600 mb-6 leading-relaxed line-clamp-4">
                {{ publication?.excerpt || publication?.description || publication?.content?.substring(0, 200) || 'Publication description' }}
              </p>
              <a 
      ...
      <div v-else class="text-center py-20">
        ...
        <p class="text-xl text-gray-600">No publications available at the moment. Check back soon!</p>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="text-center mb-16">
        ...
        <p class="text-3xl  font-bold text-gray-900 mb-4">
          We have impacted thousands of <span class="bg-gradient-to-r from-[#27628C] to-blue-600 bg-clip-text text-transparent">amazing people</span>
        </p>
      </div>
      
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div v-for="(testimonial, idx) in testimonials" :key="idx" class="group">
          <div class="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 h-full">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="text-center mb-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
          <img class="h-12 w-auto object-contain filter grayscale hover:grayscale-0 transition-all duration-300" src="@/assets/img/partner1.jpeg" alt="Partner 1">
          <img class="h-12 w-auto object-contain filter grayscale hover:grayscale-0 transition-all duration-300" src="@/assets/img/partner2.jpeg" alt="Partner 2">
          <img class="h-12 w-auto object-contain filter grayscale hover:grayscale-0 transition-all duration-300" src="@/assets/img/partner3.jpeg" alt="Partner 3">
          <img class="h-12 w-auto object-contain filter grayscale hover:grayscale-0 transition-all duration-300" src="@/assets/img/partner4.jpeg" alt="Partner 4">
          <img class="h-12 w-auto object-contain filter grayscale hover:grayscale-0 transition-all duration-300" src="@/assets/img/partner5.jpeg" alt="Partner 5">
          <img class="h-12 w-auto object-contain filter grayscale hover:grayscale-0 transition-all duration-300" src="@/assets/img/partner6.jpeg" alt="Partner 6">
        </div>
      </div>
    </div>
  </section>
